...
function OurTeam() {
  ...
  const teamMembers = [
    ...
    { img: "team4.jpg", name: "Charlotte Ford", position: "Finance Expert" },
    { img: "team5.jpg", name: "Jac Jacson", position: "Research Expert" },
    { img: "team6.jpg", name: "Micheal Smith", position: "Accounts Manager" },
    { img: "team1.jpg", name: "Keten Moris", position: "Investment Strategist" }
  ]
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-1">Our Team</h2>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            <span className="text-[#e93c05] font-semibold">Our Expert Team</span>
            <h2 className="text-3xl md:text-4xl font-bold text-[#011a41] mt-2">Meet Our Team Of Finance Experts</h2>
            <p className="mt-4 max-w-3xl mx-auto text-gray-600">
              Our team of experienced professionals is dedicated to providing exceptional financial services
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="top relative overflow-hidden rounded-t-lg">
                  <img src={`/assets/images/team/${member.img}`} alt={member.name} className="w-full" />
                  <ul className="absolute top-16 left-6">
                    <li className="block mb-2.5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                      <a href="#" target="_blank" className="block w-[45px] h-[45px] grid place-content-center text-center bg-white text-[#e93c05] hover:bg-[#011a41] hover:text-white transition-all duration-300 group-hover:[transform:rotateY(360deg)]">
                        <Facebook className="w-5 h-5" />
                      </a>
                    </li>
                    <li className="block mb-2.5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                      <a href="#" target="_blank" className="block w-[45px] h-[45px] grid place-content-center text-center bg-white text-[#e93c05] hover:bg-[#011a41] hover:text-white transition-all duration-300 group-hover:[transform:rotateX(360deg)]">
                ...
                <div className="bottom max-w-[285px] mx-auto bg-[#f5f4f4] group-hover:bg-white relative text-center pt-5 pb-6 -mt-4 shadow-md transition-all duration-300">
                  <img src="/assets/images/team/team-shape1.png" alt="Shape" className="absolute top-0 right-0 w-[35px]" />
                  <h3 className="text-2xl font-bold mb-1.5">{member.name}</h3>
                  <span className="block text-[#e93c05] font-semibold text-sm">{member.position}</span>
                </div>
              </motion.div>
            ))}
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="book-shape">
              <img src="/assets/images/book-shape1.png" alt="Shape" className="absolute top-0 left-0 z-[-1] animate-[opacity-pulse_3s_linear_infinite]" />
              <img src="/assets/images/book-shape2.png" alt="Shape" className="absolute bottom-0 right-0 z-[-1] animate-[opacity-pulse-alt_3s_linear_infinite]" />
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-2.5">Join Our Team</h2>
            <p className="text-xl text-white mb-4">We're always looking for talented individuals to join our team</p>
