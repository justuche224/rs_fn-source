...
export default function KYCAdminPage() {
  ...
  // https://resonantfinance.onrender.com
  const fetchKYCData = async () => {
    try {
      setLoading(true);
      const res = await axios.get(
        "https://resonantfinance.onrender.com/api/kyc",
        {
  ...
  const handleApprove = async (id: string) => {
    ...
    await axios
      .put(
        `https://resonantfinance.onrender.com/api/kyc/status`,
        {
          kycId: id,
          status: "APPROVED",
        },
            ...
            <Tabs defaultValue="front" className="w-full">
              ...
              <TabsContent value="front" className="flex justify-center">
                <div className="border rounded-md overflow-hidden max-h-[500px]">
                  <img
                    src={`https://resonantfinance.onrender.com/api/kyc/images/${selectedDocument.frontImage}`}
                    alt="Front Document"
              ...
              <TabsContent value="back" className="flex justify-center">
                <div className="border rounded-md overflow-hidden max-h-[500px]">
                  <img
                    src={`https://resonantfinance.onrender.com/api/kyc/images/${selectedDocument.backImage}`}
                    alt="Back Document"
                    className="object-contain max-h-[400px]"
                  />
                </div>
              ...
              <TabsContent value="selfie" className="flex justify-center">
                <div className="border rounded-md overflow-hidden max-h-[500px]">
                  <img
                    src={`https://resonantfinance.onrender.com/api/kyc/images/${selectedDocument.selfieImage}`}
                    alt="Selfie"
                    className="object-contain max-h-[400px]"
                  />
                </div>
